...
public class CutsceneCreatorWindow : EditorWindow
{
    ...
    //GUIContent[] toolbarContent = new GUIContent[] { new GUIContent("Cutscene", "Create a Cutscene with a visual track."), new GUIContent("Sequence", "Create a flexible runtime sequence.") };

    //string HeaderLabelCutscene = "Create a Cutscene";
    ...
    //GUIContent DefaultCameraContent = new GUIContent("Default Camera", "The main camera to be used in the cutscene");
    ...
    public void Awake()
    {
        ...
        EditorPrefs.SetString("CinemaDirectorVersion", "1.2.1.1");
    }
